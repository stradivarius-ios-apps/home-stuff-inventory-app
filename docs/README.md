...
| [`ci/release.md`](ci/release.md) | One-action technical release runbook and safe validation mode | Active | Release maintainer | Release workflow or handoff changes | Keep recovery separate from the normal path |
