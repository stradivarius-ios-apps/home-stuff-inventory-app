...
| [`ci/release.md`](ci/release.md) | Protected-tag technical release runbook and safe validation mode | Active | Release maintainer | Release workflow or handoff changes | Keep recovery separate from the normal path |
...
| [`product/pro-launch-bundle-contract.md`](product/pro-launch-bundle-contract.md) | Approved Pro launch-bundle contract | Active implementation contract | Product owner | Approved Pro scope or shipped bundle behavior changes | Shipped source and tests own behavior; retain the contract as the scope boundary |
...
| [`release/lifetime-pro-launch-readiness.md`](release/lifetime-pro-launch-readiness.md) | Lifetime Pro automated, manual, submission, activation, and rollback gate | Release gate | Product/release owner | Launch-bundle behavior, StoreKit, purchase UI, localization, privacy, metadata, or submission behavior changes | Revalidate for the exact candidate SHA; keep credentialed evidence outside public source |
...
| [`ci/ios-26-compatibility.md`](ci/ios-26-compatibility.md) | iOS 26.0 static and runtime compatibility procedure | Release gate | Product/release owner | iOS 26 API, deployment target, simulator contract, or release validation change | Preserve the distinction between compile-time, runtime, and actual smoke evidence |
| [`ci/ios-27-compatibility.md`](ci/ios-27-compatibility.md) | iOS 27 SDK, runtime smoke, and manual platform-review procedure | Release gate | Product/release owner | Xcode/iOS 27 SDK, simulator contract, or release validation change | Preserve the iOS 26.0 minimum-support gate and record unavailable device evidence honestly |
